    ...
    <div class="pro-items">
      <a href="pro_info.html" class="weui-media-box weui-media-box_appmsg">
        ...
        <div class="weui-media-box__bd">
          <h1 class="weui-media-box__desc">{{result.goodsName}}</h1>
          <div class="wy-pro-pri">¥<em class="num font-15">{{formatPrice(result.goodsPrice)}}/</em></div>
...
<script>
  ...
  function  load() {
    $.ajax({
      ...
      //请求地址
      url : "http://www.housekeep.com:8084/goods/queryGoodsByPage",
      //数据，json字符串
      data : {
        "key":vm.key,
        "status":1,
